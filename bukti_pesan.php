...
<head>
    <title><?php echo "Hotel Hebat - ".$nama; ?></title>
    <meta charset="utf-8">
        ...
        <div id="invoice">
            ...
            <div class="toolbar hidden-print">
                <div class="text-right">
                    ...
                    <button id="printInvoice" class="btn btn-info"><i class="fa fa-file-pdf-o"></i> Print as
                        PDF</button>
                </div>
                <hr>
            </div>
                    ...
                    <main>
                        <div class="row contacts">
                            <div class="col invoice-to">
                                ...
                                <div class="address">Magelang, TX 79273, Indonesia</div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-left">
                                        ...
                                        untuk istirahat beberapa hari kedepan serta membuat anda dapat berpikir
                                        </br>untuk rencana kedepan.
                                    </td>
