   ...
   <tbody>
     <?php
              ...
              $sql="SELECT * FROM tb_pelanggan JOIN tb_kamar ON tb_pelanggan.id_kamar = tb_kamar.id_kamar 
                    WHERE (nama_tamu LIKE ?) ORDER BY tb_pelanggan.tgl_pesan DESC LIMIT 20";
     ...
     <tr>
       ...
       <td><a href="#" data-id="" class="btn btn-info" onClick="show_modal_reservasi(this.id)"
           id="<?php echo $row["id"]; ?>">Lihat</a>
         <a href="#" data-id="" class="btn btn-primary" onClick="check_modal_reservasi(this.id)"
           id="<?php echo $row["id"]; ?>">Proses</a>
       </td>
     </tr>
     <?php
                }
